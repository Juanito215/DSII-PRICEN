...
import notesIcon from './assets/list icon.svg';
import carnesBanner from './assets/carnesBanner.png';
import featuredProductImage from './assets/carnesBanner.png';
import cheapProductImage from './assets/lomocerdo.png';
